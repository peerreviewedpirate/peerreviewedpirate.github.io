...
\renewcommand{\cftsecfont}{\bfseries}% sections in bold
\renewcommand{\cftsubsubsecfont}{\itshape}% subsubsections italicised
...
\newcommand{\sectionEnd}{
	\begin{center}
		\vspace{10pt}
		\includegraphics[width=0.9\linewidth]{../images/section_break.png}
	\end{center}
}
