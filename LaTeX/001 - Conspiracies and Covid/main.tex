...
\newcommand{\Version}{001 } % End this with a space.
\newcommand{\DateToUse}{January 2, 2022}

% Define the mode: set to true for PRINTER or false for DIGITAL
\newif\ifprinter
\printerfalse  % or \printerfalse
